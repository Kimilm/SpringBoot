...
import info.thecodinglive.reopsitory.SchoolRepository;
import info.thecodinglive.reopsitory.StudentRepository;
...
public class SchoolService {
    ...
    @Transactional // LAZY 로딩이기에 트랜젝션으로 묶어야 예외 발생시 롤백이 된다
